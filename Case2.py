...
with tab2:
    ...
    st.write("Door gebruik te maken van de dropdownmenu kan er gewisseld worden van dataset.")
    st.write("Met het vinkje wordt aangegeven of je de uitbijters wilt zien of niet.")
    st.write("Er is ook nog een extra variabele gecreëerd, namelijk 'aantal kamers'. Dit is de som van het aantal slaapkamers en badkamers plus de woonkamer.")
    ...
    st.write("Dit houdt in dat de uitbijters afwijken van de algemene trend van de data en een negatieve correlatie veroorzaken.")
    st.write("Bij dataset 2 wordt de correlatie juist zwakker bij het verwijderen van uitbijters.")
    st.write("Dit houdt in dat de uitbijters een duidelijke lineaire relatie hebben met de rest van de data.")
    st.write("Bij beide datasets heeft 'sqft_living' de hoogste positieve correlatie.")
    st.write("Dit houdt in dat hoe groter de oppervlakte van de woonkamer is, hoe hoger de prijs zou zijn.")
    st.write("We verwachten dan ook dat 'sqft_living' de beste variabele is om te voorspellen bij lineaire regressie.")
...
with tab2:
    ...
    st.write("Door middel van het dropdownmenu kan er een variabele geselecteerd worden om te vergelijken met de variabele 'price'.")
    st.write("Door gebruik te maken van het tweede dropdownmenu kan er gewisseld worden tussen datasets en kun je de regressielijnen vergelijken tussen de verschillende datasets.")
    st.write("Tenslotte kun je ook de invloed van uitbijters vergelijken door regressie door uitbijters aan of uit te zetten.")
    st.write("In beide datasets is te zien dat de variabele 'sqft_living' de beste R2-score geeft.")
    st.write("Dit was te verwachten aangezien deze variabele ook de grootste correlatie had met 'price'.")
    st.write("Echter valt wel op dat als je uitbijters weghaalt bij dataset 1, de R2-score verbetert.")
    st.write("Maar dit is niet het geval bij dataset 2; als je hier de uitbijters weghaalt, wordt de R2-score slechter.")
    st.write("Dit komt doordat uitbijters de schattingen van de modelparameters (hellingen) beïnvloeden.")
    st.write("Verder kunnen uitbijters de voorspellende waarde van het model verminderen doordat ze ver weg van de andere datapunten liggen.")
    st.write("Tenslotte beïnvloedt het de heteroscedasticiteit, ook wel de spreiding van de data.")
    st.write("In een vervolgonderzoek kan de regressie nog verbeterd worden door de data te normaliseren.")
    st.write("Dit kan onder andere door transformaties toe te passen waardoor de data normaal verdeeld wordt.")
