...
with tab1:
    ...
    st.write("- Feature Engineering: Overweeg het maken van nieuwe kenmerken op basis van bestaande variabelen. Bijvoorbeeld het berekenen van de prijs per vierkante meter of het creëren van categorieën op basis van het aantal slaapkamers of badkamers.")
    st.write("- Interpretatie van Resultaten: Nadat je de analyses hebt uitgevoerd, interpreteer je de bevindingen en conclusies. Wat vertellen de gegevens je over huisprijzen in King County? Zijn er interessante patronen of inzichten?")
    st.write("- Communicatie van Resultaten: Deel je bevindingen en analyses in een duidelijke en begrijpelijke indeling. Dit kan een blogpost zijn zoals deze, een rapport, of een presentatie, afhankelijk van je doelpubliek.")
