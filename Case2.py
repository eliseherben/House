...
with tab1:
    ...
    st.write("Welkom!"
             "In deze blog willen we je graag meenemen in onze analyse van de datasets die we hebben onderzocht."
    ...
    st.write("Hier zijn enkele stappen die we  overwegen bij het analyseren van deze dataset over huisprijzen in King County, USA:"
             "- Data Verkenning: Begin van het verkennen van de dataset. Bekijk de beschikbare kolommen en begrijp de betekenis van elke variabele. Controleer ook op ontbrekende waarden of ongeldige gegevens."
             "- Data Visualisatie: Maak grafieken en visualisaties om de verdeling van huisprijzen en andere belangrijke kenmerken te begrijpen. Dit kan histogrammen, scatterplots en boxplots omvatten."
             "- Statistische Analyse: Voer statistische analyses uit om de relaties tussen verschillende variabelen te begrijpen. Dit kan correlatie-analyse en regressie-analyse omvatten. "
             "- Feature Engineering: Overweeg het maken van nieuwe kenmerken op basis van bestaande variabelen. Bijvoorbeeld het berekenen van de prijs per vierkante meter of het creëren van categorieën op basis van het aantal slaapkamers of badkamers."
             "- Interpretatie van Resultaten: Nadat je de analyses hebt uitgevoerd, interpreteer je de bevindingen en conclusies. Wat vertellen de gegevens je over huisprijzen in King County? Zijn er interessante patronen of inzichten?"
             "- Communicatie van Resultaten: Deel je bevindingen en analyses in een duidelijke en begrijpelijke indeling. Dit kan een blogpost zijn zoals deze, een rapport, of een presentatie, afhankelijk van je doelpubliek.")
